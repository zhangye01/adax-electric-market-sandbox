...
- retail shell, market board/load/price/months/briefs, trade base/reference/cards/controls/feedback, result base, settlement, result breakdown, result-review, and review styles
