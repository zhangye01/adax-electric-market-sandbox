...
- home/about/records/flow page styles, with home split into shell/hero/sections/records/boundary, mode flow split into base/decision/confirmation/path/records, role flow split into cards/details/ecosystem/info-pack/seat-summary, and scenario flow split into shell/market/activity/confirmation
- cockpit base, summary, layout, controls, panels, review, output, mode-card, comparison/event, feedback, notice, and message surface styles
