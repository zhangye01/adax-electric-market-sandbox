...
| New participant implementation starting before scope confirmation | High | Require a confirmed participant startup card before code; current candidate cards are `docs/ADAX_RENEWABLE_STARTUP_CARD.md` and `docs/ADAX_INDEPENDENT_STORAGE_STARTUP_CARD.md`, both pending confirmation |
