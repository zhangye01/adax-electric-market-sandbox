...
| Global CSS coupling | Reduced | Styles are split by responsibility; records, cockpit controls, shared flow lists, and retail review surfaces now have separate shell/input/action/template/data/step/helper/prompt/material/progress partitions, and obsolete review-cockpit CSS has been removed; continue avoiding cross-page selectors |
